...
if __name__ == "__main__":
    ...
    s = open('/Users/martinapivarnikova/Documents/trie.txt', 'w')

    # print(trie('a.root-servers.net'[::-1]))
    for line in file:
        split_dq = line.split(" ")
        dn = split_dq[8]
        ...
        if domain_name is not None and trie(domain_name) is False:
            s.write(dn)
            s.write('\n')
